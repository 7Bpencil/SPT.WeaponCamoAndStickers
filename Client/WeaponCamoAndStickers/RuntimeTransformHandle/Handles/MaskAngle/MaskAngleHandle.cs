...
namespace RuntimeHandle
{
    ...
    public class MaskAngleHandle : ITransformHandle
    {
        ...
        public void Init(Transform transformHandle, Camera transformHandleCamera, Shader handleShader, Transform root)
        {
            ...
            var axisY = new GameObject("MaskAngleAxis.Y (XZ)").AddComponent<RotationAxis>().Initialize(transformHandle, transformHandleCamera, root, rotationHandleY, Vector3.up, Color.green, handleShader);
        }
