...
namespace RuntimeHandle
{
    ...
    public class ScaleHandle : MonoBehaviour
    {
            ...
            Decal decal)
        {
			...
			var scaleHandlerXZ = new ScalePlaneHandler_Transform(decalInfo, decal, Vector3.right + Vector3.forward);
            ...
            var planeXZ = new GameObject("ScalePlane.XZ").AddComponent<ScalePlane>().Initialize(transformHandle, scaleHandleTransform, scaleHandlerXZ, axisX, axisZ, Vector3.up, Color.green, handleShader);
