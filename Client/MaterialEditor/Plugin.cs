...
namespace SevenBoldPencil.MaterialEditor
{
    ...
    [BepInPlugin("7Bpencil.MaterialEditor", "7Bpencil.MaterialEditor", "1.18.0")]
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public bool IsSupportedShader(Material material)
        {
            ...
            // TODO poster shaders don't have some parameters which leads to errors, but whatever...
        ...
        public void RenderCombinedTexture(RenderTexture renderTexture, Texture color, Vector4 colorUV, float textureAngle, Texture alpha)
        {
            ...
            var colorTextureRotation = UVTools.GetRotationVector(textureAngle);
            CombineTexturesMaterial.SetVector(_ColorTex_ST, colorUV);
            CombineTexturesMaterial.SetVector(_ColorTexRotation, colorTextureRotation);
