...
{
    public class TextureAngleAxis : HandleBase
    {
        ...
        public TextureAngleAxis Initialize(
			RuntimeTransformHandle transformHandle,
			TextureAngleHandle rotationHandle,
			Vector3 perp,
			Color color,
			Shader handleShader,
			DecalInfo decalInfo,
        ...
        public override void Interact()
        {
			...
			_decalInfo.TextureAngle = _startAngle + angle * sign;
